...
const representativeMenuItems = [
  { icon: LayoutDashboard, label: "Dashboard", path: "/representative/dashboard" },
  { icon: Package, label: "Products", path: "/representative/products" },
  { icon: Calendar, label: "Visits", path: "/representative/visits" },
  { icon: MapPin, label: "Locations", path: "/representative/locations" },
  { icon: BarChart3, label: "Reports", path: "/representative/reports" },
  { icon: Wallet, label: "Wallet", path: "/representative/wallet" },
  { icon: Settings, label: "Settings", path: "/representative/settings" },
];
